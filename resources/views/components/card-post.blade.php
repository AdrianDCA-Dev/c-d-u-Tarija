...
<article class="mb-8 bg-white shadow-lg rounded-lg overflow-hidden">
    @if($post->image)
        <img class="w-full h-auto object-cover object-center" class="" src="{{Storage::url($post->image->url)}}">
    @else
        <img class="w-full h-auto object-cover object-center" class="" src="https://cdn.pixabay.com/photo/2021/08/25/20/42/field-6574455_960_720.jpg">
    @endif
    <div class="px-6 py-4">
